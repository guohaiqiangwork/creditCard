	...
	<view class="">
		<view class="background_colorff">
			...
			<view class="uni-flex background_colorff padding_top3">
				<view class="uni-flex searce_moudel" style="box-shadow:none;border: 1px solid #CCCCCC;">
					<view class="searce_left"><image src="../../../static/image/icon/searce.png" class="searce_width" mode=""></image></view>
					<view class="searce_right">
						<input
							class="width90"
							:value="inputValue"
							placeholder="输入需要查找的名称或手机号"
							confirm-type="搜索"
							type="text"
							@confirm="Search"
				...
				<view class="font_size26 text_center width10 margin_top2" @click="qx">取消</view>
			</view>
			...
			<view class="font_size28 margin_left3 padding_top3 padding_bottom2">团队人数：{{ totalNumber }}人</view>
		</view>
		<!-- list -->
		<view class="page_width">
			<view v-if="teamDirectPushList.length > 0" class="list_moudel" v-for="(item, index) in teamDirectPushList" :key="index">
				<view class="text_right font_size22 font_colorcc margin_right3 padding_top2">{{ item.createTime }}</view>
				<view class="uni-flex margin_left3 margin_top2">
					<view class="width20 margin_top3"><image :src="item.headImgurl" class="img_heard" mode=""></image></view>
					<view class="width60">
						<view class="uni-flex">
			...
			<view class="" v-if="teamDirectPushList.length == 0">
				<view class="text_center">
					<template v-if="!scersfalg">
						<image src="../../../static/image/noContent/noCapital.png" class="nolist" mode=""></image>
					...
					<template v-if="scersfalg">
						<view class="text_center">
							<image src="../../../static/image/noContent/noS.png" class="nolist" mode=""></image>
							<view class="font_size28 font_colorcc">
								没有找到您要的信息~
							</view>
						</view>
		...
		<template v-if="myQF">
			<view class="moudel_content">
				<view class="pay_result_moudel">
					<view class="">
						<image @click="closeMoudel" src="../../../static/image/icon/colse.png"  style="width: 26upx;height: 26upx;margin-top: 5%;margin-left: 5%;" mode=""></image>
					</view>
					<view class="text_center">
						<template>
							<image :src="moudelWxQr" style="width: 305upx;height: 644upx;margin-top: 30upx;" mode=""></image>
							<view class="font_size30 font_color99">长按识别二维码添加好友</view>
						</template>
		...
		<template v-if="noPhone">
			<view class="moudel_content">
				<view class="phone_moudel">
					<view class="font_size34">提示</view>
					<view class="font_size30 margin_top5">推荐人暂未绑定手机号码！</view>
					<view class="phone_btn" @click="closePhone">确定</view>
				</view>
			</view>
		</template>
	</view>
